 ...
 */
public class DuplicateStyledDocument extends AbstractDocument implements StyledDocument {
     ...
     */
    public DuplicateStyledDocument(AbstractDocument.Content c, StyleContext styles) {
        super(c, styles);
     ...
     */
    public DuplicateStyledDocument(StyleContext styles) {
     ...
     */
    public DuplicateStyledDocument() {
    ...
    protected void create(ElementSpec[] data) {
        try {
            ...
            AbstractDocument.DefaultDocumentEvent evnt =
                    new AbstractDocument.DefaultDocumentEvent(0, length, DocumentEvent.EventType.INSERT);
            evnt.addEdit(cEdit);
            ...
            throw new DuplicateStateInvariantError("problem initializing");
        } finally {
            writeUnlock();
        }
    ...
    protected void insert(int offset, ElementSpec[] data) throws BadLocationException {
        ...
        try {
            ...
            int length = sb.length();
            AbstractDocument.DefaultDocumentEvent evnt =
                    new AbstractDocument.DefaultDocumentEvent(offset, length, DocumentEvent.EventType.INSERT);
            evnt.addEdit(cEdit);
    ...
    private void removeElementImpl(Element elem) {
        ...
        boolean atEnd = false;
        boolean isComposedText = Util.isComposedTextElement(elem);
        ...
        AbstractDocument.DefaultDocumentEvent dde = new AbstractDocument.DefaultDocumentEvent(removeFrom,
                length, AbstractDocument.DefaultDocumentEvent.EventType.REMOVE);
        ...
        if (atEnd) {
            ...
            dde.addEdit(new AbstractDocument.ElementEdit(prevParent, prevIndex,
    ...
    public void setLogicalStyle(int pos, Style s) {
        ...
        if ((paragraph != null) && (paragraph instanceof AbstractDocument.AbstractElement)) {
            try {
                writeLock();
                StyleChangeUndoableEdit edit = new StyleChangeUndoableEdit((AbstractDocument.AbstractElement)paragraph, s);
                ((AbstractDocument.AbstractElement)paragraph).setResolveParent(s);
                int p0 = paragraph.getStartOffset();
                int p1 = paragraph.getEndOffset();
                AbstractDocument.DefaultDocumentEvent e =
                        new AbstractDocument.DefaultDocumentEvent(p0, p1 - p0, DocumentEvent.EventType.CHANGE);
                e.addEdit(edit);
                e.end();
                fireChangedUpdate(e);
    ...
    public void setCharacterAttributes(int offset, int length, AttributeSet s, boolean replace) {
        ...
        try {
            ...
            AbstractDocument.DefaultDocumentEvent changes =
                    new AbstractDocument.DefaultDocumentEvent(offset, length, DocumentEvent.EventType.CHANGE);
    ...
    protected AbstractDocument.AbstractElement createDefaultRoot() {
        ...
        writeLock();
        AbstractDocument.BranchElement section = new SectionElement();
    ...
    public void addDocumentListener(DocumentListener listener) {
        synchronized(listeningStyles) {
            ...
            if (oldDLCount == 0) {
                ...
                if (styleContextChangeListener != null) {
                    StyleContext styles = (StyleContext)getAttributeContext();
                    java.util.List<ChangeListener> staleListeners =
    ...
    public class ElementBuffer implements Serializable {
        ...
        void endEdits(AbstractDocument.DefaultDocumentEvent de) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                int index = ec.index;
                ((AbstractDocument.BranchElement) ec.parent).replace(index, removed.length, added);
                AbstractDocument.ElementEdit ee = new AbstractDocument.ElementEdit(ec.parent, index, removed, added);
                de.addEdit(ee);
            }
    ...
    public static class AttributeUndoableEdit extends AbstractUndoableEdit {
         ...
         * Redoes a change.
         *
         * @exception javax.swing.undo.CannotRedoException if the change cannot be redone
         */
         ...
         * Undoes a change.
         *
         * @exception javax.swing.undo.CannotUndoException if the change cannot be undone
         */
    ...
    static class StyleChangeUndoableEdit extends AbstractUndoableEdit {
        public StyleChangeUndoableEdit(AbstractDocument.AbstractElement element,
                                       Style newStyle) {
            super();
            this.element = element;
    ...
    abstract static class AbstractChangeHandler implements ChangeListener {
         ...
         */
        static java.util.List<ChangeListener> getStaleListeners(ChangeListener l) {
            java.util.List<ChangeListener> staleListeners = new ArrayList<ChangeListener>();
    ...
    class ChangeUpdateRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                writeLock();
                AbstractDocument.DefaultDocumentEvent dde = new AbstractDocument.DefaultDocumentEvent(0,
                        getLength(),
